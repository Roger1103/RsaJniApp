...
std::string BASE64Util::base64_encodestring(const std::string &text ){
    EVP_ENCODE_CTX ectx;
...
std::string BASE64Util::base64_decodestring(const std::string &text ){
    EVP_ENCODE_CTX ectx;
...
std::string BASE64Util::base64_decode(const std::string& encoded_bytes, int *decoded_length) {
    BIO *bioMem, *b64;
...
std::string BASE64Util::base64_encode(const std::string& decoded_bytes,
