...
public class RsaUtils {
    ...
    public static void genKeyPair() {
        ...
        Log.e("RSA", Base64.encodeToString(privateKey.getEncoded(), Base64.DEFAULT));
        Log.e("RSA", Base64.encodeToString(publicKey.getEncoded(), Base64.DEFAULT));
    }
     ...
     */
    public static byte[] encrypt(RSAPublicKey publicKey, String plainTextData) throws Exception {
        if (publicKey == null) {
